...
namespace P224Allup.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(RoleManager<IdentityRole> roleManager, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, AllupDbContext context)
        {
        ...
        public async Task<IActionResult> Login(LoginVM loginVM)
        {
            ...
            AppUser appUser = await _userManager.Users.FirstOrDefaultAsync(u => u.Email == loginVM.Email && !u.IsAdmin);
